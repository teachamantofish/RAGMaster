...
EXCLUDED_TAGS = ["form", "script", "style", "footer", "header", "nav"] # OMIT tags with needed links (e.g. nav)
REMOVE_FORMS = True                     # Specifically strip <form> elements
REMOVE_OVERLAY_ELEMENTS = True          # Attempt to remove modals/popups
CSS_SELECTOR = ".dexter-Position"  # Get this region only. Wildcards examples: '[id^="ad_"], [class*="sponsor"]'. Use any CSS selector.
EXCLUDED_SELECTOR = ".language-Navigation, .dexter-Author-Hide"  # [class*="modal"]
